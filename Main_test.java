...
//Heroのメソッド確認
 ...
 System.out.println("HEROのattack!-----20ダメージ");
 h.attack(ma);
 System.out.println("HERO:" + h.getName() + "/" + h.getHp() + "/" + h.getMp());
 System.out.println("MATANGO:" + ma.getName() + "/" + ma.getHp());
 System.out.println("     ");

 System.out.println("HEROのaid!-----指定の味方を20回復、MP5消費");
 h.aid(h);
 System.out.println("HERO:" + h.getName() + "/" + h.getHp() + "/" + h.getMp());
 h.aid(f);
 System.out.println("FIGHTER:" + f.getName() + "/" + f.getHp() + "/" + f.getMp());
 ...
 System.out.println("HEROのthunder!-----50ダメージ、MP15消費");
 h.thunder(ma);
 System.out.println("HERO:" + h.getName() + "/" + h.getHp() + "/" + h.getMp());
 System.out.println("MATANGO:" + ma.getName() + "/" + ma.getHp());
 System.out.println("     ");
...
System.out.println("FIGHTERのattack!-----（瞑想前）5ダメージ * 1～1.9、瞑想中は2回攻撃");
f.attack(ma);
...
System.out.println("FIGHTERのattack!-----(瞑想後）5ダメージ * 1～1.9、瞑想中は2回攻撃");
f.attack(ma);
System.out.println("FIGHTER:" + f.getName() + "/" + f.getHp() + "/" + f.getMp() + "/" + f.getMdt());
System.out.println("MATANGO:" + ma.getName() + "/" + ma.getHp());
System.out.println("     ");
...
//Matangoのメソッド確認
 ...
 System.out.println("MATANGOのpoison!-----10ダメージ or 3MP消費、HPを2消費");
 ma.poison(h);
 System.out.println("HERO:" + h.getName() + "/" + h.getHp() + "/" + h.getMp());
 System.out.println("MATANGO:" + ma.getName() + "/" + ma.getHp());
 System.out.println("     ");
...
//Dragonのメソッド確認
 ...
 System.out.println("DRAGONのbite!-----20ダメージ");
 d.bite(h);
 System.out.println("HERO:" + h.getName() + "/" + h.getHp() + "/" + h.getMp());
 System.out.println("DRAGON:" + d.getName() + "/" + d.getHp());
 System.out.println("     ");
